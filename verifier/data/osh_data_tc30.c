...
#define FUNC_VALUE  shmem_longdouble_put
 ...
 ***************************************************************************/
int osh_data_tc30(const TE_NODE *node, int argc, const char *argv[])
{
    int rc = TC_PASS;
